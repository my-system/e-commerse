  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newProduct = {
        ...
        category: categoryMap[formData.category] || formData.category, // Save category name, not ID
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">
                  Produk akan ditinjau oleh admin sebelum ditampilkan di marketplace
                </p>
              </div>
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {isSubmitting ? (
                    <>
