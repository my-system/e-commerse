        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-between h-16 w-full">
            ...
            <div className="md:hidden flex items-center gap-2 z-20">
              {/* Search Icon - Mobile */}
              <button
                className="relative p-3 text-white hover:text-white/80 transition-colors duration-200"
                onClick={() => {
              ...
              <button
                onClick={toggleSidebar}
                className="p-3 text-white hover:text-white/80 transition-colors duration-200 relative z-50"
                aria-label="Buka menu"
                style={{ pointerEvents: 'auto' }}
              >
                <Menu className="h-6 w-6" />
